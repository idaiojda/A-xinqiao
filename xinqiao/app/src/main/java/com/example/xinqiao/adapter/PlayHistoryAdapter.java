...
public class PlayHistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tvVideoBadge = convertView.findViewById(R.id.tv_video_badge);
            holder.dotUnfinished = convertView.findViewById(R.id.dot_unfinished);
        ...
        // 设置未完成红点（当前无进度数据，默认隐藏；未来可按播放进度控制）
