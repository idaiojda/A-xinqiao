...
import com.example.xinqiaobackend.entity.CounselorApplication;
import com.example.xinqiaobackend.entity.User;
import com.example.xinqiaobackend.repository.CounselorApplicationRepository;
...
public class AdminApplicationsController {
    ...
    @GetMapping
    public List<CounselorApplication> list(@RequestParam(required = false) String status,
                                           @RequestParam(required = false) String query) {
        return applicationRepository.adminList(status, query);
    }
